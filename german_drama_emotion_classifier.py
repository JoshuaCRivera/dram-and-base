...
data = data[data['tag_type'] != 'no_annotation'] 
X = data['text']
y_emotion = data['tag_type']
y_polarity = data['polarity'] 

X_train, X_test, y_train_emotion, y_test_emotion, y_train_polarity, y_test_polarity = train_test_split(X, y_emotion, y_polarity, test_size=0.2, random_state=42)
